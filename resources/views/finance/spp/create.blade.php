...
@section('content')
    <div class="flex flex-col gap-6 w-full mx-auto pb-10">
        ...
        <div
                ...
                <div class="flex flex-col sm:flex-row items-center sm:items-start gap-6 text-center sm:text-left">
                    ...
                    <div>
                        <div class="flex items-center gap-3 mb-2">
                            <h1 class="text-2xl font-bold text-slate-900 dark:text-white tracking-tight">Tambah Pembayaran SPP
                            </h1>
                            <div class="px-3 py-1 rounded-full bg-primary/10 text-primary text-xs font-bold border border-primary/20">
                                {{ $activeYear->name }}
                            </div>
                        </div>
                        <p class="text-slate-500 dark:text-slate-400 text-base max-w-xl">Catat pembayaran SPP santri baru
                            ke dalam sistem.</p>
                    </div>
                </div>
            </div>
            ...
            {{-- Form --}}
            <form action="{{ route('admin.spp-payments.store') }}" method="POST" class="p-4 sm:p-8">
                @csrf
                ...
                <div class="grid grid-cols-1 gap-8">
                    ...
                    <div class="space-y-6">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div class="relative group">
                                    ...
                                    <select name="student_id" required style="background-image: none;"
                                        ...
                                        @if($preselectedStudent)
                                            <option value="{{ $preselectedStudent->id }}" selected
                                                data-info="({{ $preselectedStudent->rayon?->name }} - {{ $preselectedStudent->room?->name }})">
                            ...
                            {{-- Tahun Ajaran (Hidden) --}}
                            <input type="hidden" name="academic_year_id" id="academic_year_id" value="{{ $activeYear->id }}">
