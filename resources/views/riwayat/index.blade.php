...
@section('content')
    ...
    <div class="rounded-2xl p-4 sm:p-6 border border-blue-100 mb-6"
        ...
        <div class="flex flex-col xl:flex-row xl:items-center justify-between gap-4">
            <div class="flex flex-col gap-1">
                <h1 class="text-[#0d141b] dark:text-white text-2xl font-black tracking-tight">Riwayat Perhitungan</h1>
                <p class="text-[#4c739a] text-sm sm:text-base font-normal">Arsip hasil perhitungan SAW berdasarkan periode
                    penilaian
                </p>
            </div>
        </div>
    ...
    <div class="bg-white dark:bg-slate-900 rounded-xl shadow-sm border border-[#e7edf3] dark:border-slate-800 p-5">
        <form action="{{ route('perhitungan.history') }}" method="GET" class="flex flex-col md:flex-row gap-4">
            ...
            <div class="relative w-full md:w-48">
                <select name="periode_filter" style="background-image: none;"
