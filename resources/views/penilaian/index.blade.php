        ...
        <div class="flex flex-col lg:flex-row gap-4 justify-between items-end lg:items-center">
            <div class="flex flex-col md:flex-row gap-4 w-full lg:w-auto">
                ...
                <div class="relative w-full md:w-48">
                    <select style="background-image: none;"
        ...
        <div class="overflow-x-auto">
            <table class="w-full text-sm text-left text-[#4c739a]">
                <thead
                    ...
                    <tr>
                        <th class="px-6 py-4 font-bold tracking-wider whitespace-nowrap" scope="col">Nama Santri</th>
                        ...
                        <th class="px-6 py-4 font-bold tracking-wider text-right whitespace-nowrap" scope="col">Aksi</th>
                    </tr>
                </thead>
        ...
        @if($penilaian->hasPages())
            <div
                ...
                <span class="text-sm text-[#4c739a] text-center md:text-left">
                    Menampilkan <span class="font-semibold text-[#0d141b] dark:text-white">{{ $penilaian->firstItem() }}</span>
                    sampai
                    <span class="font-semibold text-[#0d141b] dark:text-white">{{ $penilaian->lastItem() }}</span> dari
                    <span class="font-semibold text-[#0d141b] dark:text-white">{{ $penilaian->total() }}</span> data
                </span>
