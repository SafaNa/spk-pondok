...
@section('content')
    <div class="flex flex-col gap-6 w-full mx-auto pb-10">
        ...
        <div
            ...
            {{-- Header --}}
            <div
                class="bg-gradient-to-br from-primary/10 via-blue-500/5 to-indigo-500/5 px-6 py-6 sm:px-8 sm:py-8 border-b border-primary/10">
                <div class="flex flex-col sm:flex-row items-center sm:items-start gap-6 text-center sm:text-left">
                    ...
                    <div>
                        <h1 class="text-2xl font-bold mb-2 text-slate-900 dark:text-white tracking-tight">Edit Departemen
                        </h1>
                        <p class="text-slate-500 dark:text-slate-400 text-base max-w-xl">Perbarui informasi departemen yang
                            sudah ada dalam sistem.</p>
                    </div>
                </div>
            </div>

            {{-- Form --}}
            <form action="{{ route('admin.departments.update', $departemen->id) }}" method="POST" class="p-6 sm:p-10">
                @csrf
                @method('PUT')
                ...
                <div class="grid grid-cols-1 gap-8">
                            ...
                            <div class="space-y-2">
                                ...
                                <div class="relative group">
                                    ...
                                    <input type="text" name="singkatan"
                                        value="{{ old('singkatan', $departemen->singkatan) }}" required
                                        class="w-full pl-12 pr-4 py-3.5 rounded-xl border-2 border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-800 text-slate-800 dark:text-white placeholder:text-slate-400 font-medium uppercase focus:outline-none focus:border-primary focus:bg-white dark:focus:bg-slate-900 focus:ring-4 focus:ring-primary/10 transition-all duration-200"
                        ...
                        <div class="space-y-2">
                            ...
                            <div class="relative group">
                                ...
                                <textarea name="keterangan" rows="4"
                                    ...
                                    placeholder="Jelaskan tugas pokok dan fungsi departemen ini...">{{ old('keterangan', $departemen->keterangan) }}</textarea>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="space-y-6">
                        <h3
                            ...
                            Akun Pengguna Departemen
                        </h3>
                        <p class="text-sm text-slate-500 dark:text-slate-400 -mt-4">Kosongkan password jika tidak ingin menggantinya.</p>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div class="space-y-2">
                                ...
                                <div class="relative group">
                                    ...
                                    <input type="email" name="user_email"
                                        value="{{ old('user_email', $userAkun?->email) }}" required
                                        class="w-full pl-12 pr-4 py-3.5 rounded-xl border-2 border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-800 text-slate-800 dark:text-white placeholder:text-slate-400 font-medium focus:outline-none focus:border-primary focus:bg-white dark:focus:bg-slate-900 focus:ring-4 focus:ring-primary/10 transition-all duration-200"
                            ...
                            <div class="space-y-2">
                                ...
                                <div class="relative group">
                                    ...
                                    <input type="password" name="user_password" minlength="6"
                                        class="w-full pl-12 pr-4 py-3.5 rounded-xl border-2 border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-800 text-slate-800 dark:text-white placeholder:text-slate-400 font-medium focus:outline-none focus:border-primary focus:bg-white dark:focus:bg-slate-900 focus:ring-4 focus:ring-primary/10 transition-all duration-200"
