                ...
                <div class="grid grid-cols-1 gap-6">
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="relative group">
                            ...
                            <input type="number" name="spp_amount" id="spp_amount" value="{{ old('spp_amount', 0) }}" min="0"
                                class="w-full pl-12 pr-4 py-3.5 rounded-xl border border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-800 text-slate-800 dark:text-white font-medium focus:outline-none focus:border-primary focus:bg-white dark:focus:bg-slate-900 focus:ring-4 focus:ring-primary/10 transition-all duration-200"
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="relative group">
                            ...
                            <input type="number" name="max_leaves" id="max_leaves" value="{{ old('max_leaves') }}" min="1"
                                class="w-full pl-12 pr-4 py-3.5 rounded-xl border border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-800 text-slate-800 dark:text-white font-medium focus:outline-none focus:border-primary focus:bg-white dark:focus:bg-slate-900 focus:ring-4 focus:ring-primary/10 transition-all duration-200"
                                placeholder="Kosongkan jika tidak ada batas">
                        </div>
                        <p class="text-xs text-slate-400">Jumlah maksimal izin pulang yang disetujui per santri. Kosongkan
                            jika tidak ada batasan.</p>
