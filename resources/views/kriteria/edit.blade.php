    ...
    <div class="space-y-6">
        ...
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="mt-1 text-gray-600">Perbarui data kriteria</p>
            </div>
            <a href="{{ route('kriteria.index') }}"
                class="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md text-[var(--color-primary-700)] bg-[var(--color-primary-100)] hover:bg-[var(--color-primary-200)] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[var(--color-primary-500)] transition-colors duration-200">
        ...
        <div class="glass-card rounded-2xl p-6 shadow-xl">
            <form action="{{ route('kriteria.update', $kriterium->id) }}" method="POST" class="space-y-6">
                @csrf
                @method('PUT')
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="form-group">
                        ...
                        <div class="relative">
                            ...
                            <input type="number" step="0.01" min="0" name="bobot" id="bobot"
                                value="{{ old('bobot', $kriterium->bobot) }}" required
                                class="pl-10 py-3 text-base block w-full rounded-lg border-gray-300 shadow-sm focus:border-[var(--color-primary-500)] focus:ring focus:ring-[var(--color-primary-200)] focus:ring-opacity-50 transition duration-200"
                        ...
                        <div class="relative">
                            ...
                            <select id="jenis" name="jenis" required
                                ...
                                <option value="benefit" {{ old('jenis', $kriterium->jenis) == 'benefit' ? 'selected' : '' }}>
                                    Benefit (Semakin besar semakin baik)</option>
                                <option value="cost" {{ old('jenis', $kriterium->jenis) == 'cost' ? 'selected' : '' }}>Cost
                                    (Semakin kecil semakin baik)</option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="form-group md:col-span-2">
                        ...
                        <div class="relative">
                            ...
                            <textarea id="keterangan" name="keterangan" rows="3"
                                ...
                                style="min-height: 100px;">{{ old('keterangan', $kriterium->keterangan) }}</textarea>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="flex justify-between items-center">
                        ...
                        <div class="space-x-3">
                            ...
                            <button type="submit"
                                ...
                                <i class="fas fa-save mr-2"></i> Perbarui Kriteria
                            </button>
                        </div>
                    </div>
                </div>
