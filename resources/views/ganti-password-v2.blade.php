    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div class="lg:col-span-1 space-y-4">
            <div>
                ...
                <p class="mt-2 text-[#4c739a] leading-relaxed">
                    Ensure your account stays secure by updating your password regularly. We recommend using a unique
                    password that you don't use for any other online account.
                </p>
            </div>
            <!-- Security Tip Card -->
            <div class="bg-blue-50 dark:bg-slate-800 border border-blue-100 dark:border-slate-700 rounded-lg p-4 mt-6">
