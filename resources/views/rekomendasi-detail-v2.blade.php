    ...
    <div class="flex flex-col md:flex-row md:items-start justify-between gap-4">
        <div class="flex items-start gap-4">
            <a href="{{ route('rekomendasi-v2') }}"
                class="flex items-center justify-center w-10 h-10 rounded-lg bg-white dark:bg-slate-800 border border-[#e7edf3] dark:border-slate-700 text-[#4c739a] hover:text-primary transition-colors">
                <span class="material-symbols-outlined">arrow_back</span>
            </a>
            <div>
                <h1 class="text-[#0d141b] dark:text-white text-2xl font-black tracking-tight">Detail Perhitungan SAW</h1>
            ...
            <table class="w-full text-left border-collapse">
                <thead>
                    <tr
                        ...
                        <th class="px-6 py-4 font-semibold">Kriteria</th>
                        ...
                        <th class="px-6 py-4 font-semibold">Min/Max</th>
                        <th class="px-6 py-4 font-semibold">Normalisasi</th>
                        <th class="px-6 py-4 font-semibold">Preferensi</th>
                    </tr>
                </thead>
