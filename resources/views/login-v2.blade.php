    ...
    <div class="min-h-screen flex w-full">
        ...
        <div class="hidden lg:flex w-1/2 relative bg-primary overflow-hidden flex-col justify-between p-12 text-white">
            ...
            <div class="relative z-10 max-w-lg">
                ...
                <p class="text-lg text-blue-50 leading-relaxed opacity-90">
                    An objective decision support system using the Simple Additive Weighting (SAW) method to streamline
                    and validate santri homecoming recommendations.
                </p>
            </div>
            <div class="relative z-10 text-sm text-blue-100 opacity-60">
                © 2024 Pesantren Administration System.
            </div>
        </div>
        ...
        <div class="w-full lg:w-1/2 flex flex-col justify-center items-center p-6 md:p-12 relative">
            ...
            <div class="w-full max-w-[480px] flex flex-col gap-6">
                ...
                <!-- Footer / Home Link -->
                <div
                    class="flex items-center justify-center gap-2 mt-4 pt-6 border-t border-[#e7edf3] dark:border-slate-800">
                    <span class="text-sm text-[#4c739a] dark:text-slate-500">Not an administrator?</span>
                    <a class="text-sm font-bold text-[#0d141b] dark:text-slate-200 hover:text-primary dark:hover:text-primary transition-colors inline-flex items-center gap-1"
                        href="#">
                        Return to Home
