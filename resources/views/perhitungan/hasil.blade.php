                    ...
                    <div class="bg-gray-50 p-4 rounded-lg">
                        <dl class="grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-4">
                            <div class="px-4 py-5 bg-white shadow rounded-lg overflow-hidden sm:p-6">
                                ...
                                <dd class="mt-1 text-xl font-semibold text-gray-900 truncate" title="{{ $santri->nama }}">
                                    {{ $santri->nama }}
                                </dd>
                            </div>
                            <div class="px-4 py-5 bg-white shadow rounded-lg overflow-hidden sm:p-6">
                                <dt class="text-sm font-medium text-gray-500 truncate">NIS</dt>
                                <dd class="mt-1 text-xl font-semibold text-gray-900">{{ $santri->nis }}</dd>
                            </div>
                            <div class="px-4 py-5 bg-white shadow rounded-lg overflow-hidden sm:p-6">
                                <dt class="text-sm font-medium text-gray-500 truncate">Nilai Akhir</dt>
                                <dd class="mt-1 text-2xl font-semibold 
                                        @if($perhitungan['nilai_akhir'] >= 0.7) text-green-600 
                                        @elseif($perhitungan['nilai_akhir'] >= 0.4) text-yellow-600 
                                        @else text-red-600 
                                        @endif">
                            ...
                            <div class="px-4 py-5 bg-white shadow rounded-lg overflow-hidden sm:p-6">
                                ...
                                <dd class="mt-1 font-bold leading-tight whitespace-nowrap">
                                    @if($perhitungan['nilai_akhir'] >= 0.7)
                                        <span class="text-green-600 text-base sm:text-lg">Direkomendasikan</span>
                                    @elseif($perhitungan['nilai_akhir'] >= 0.4)
                                        <span class="text-yellow-600 text-base sm:text-lg">Dipertimbangkan</span>
                                    @else
                                        <span class="text-red-600 text-sm sm:text-base">Tidak Direkomendasikan</span>
                                    @endif
                                </dd>
                            </div>
                        </dl>
                    ...
                    <div class="flex">
                        ...
                        <div class="ml-3">
                            <p class="text-sm text-blue-700">
                                {{ $perhitungan['alasan'] ?? 'Tidak ada alasan tersedia.' }}
                            </p>
                        </div>
                    </div>
                </div>
