                                        ...
                                        <tbody class="bg-white divide-y divide-gray-100">
                                            @foreach($items as $index => $item)
                                                <tr class="hover:bg-gray-50 transition-colors group">
                                                    ...
                                                    <td class="px-6 py-4 whitespace-nowrap">
                                                        <span
                                                            class="inline-flex items-center px-2.5 py-1 rounded-md text-xs font-bold {{ $item->nilai_akhir > 0.8 ? 'bg-green-100 text-green-700' : ($item->nilai_akhir > 0.5 ? 'bg-yellow-100 text-yellow-700' : 'bg-red-100 text-red-700') }}">
