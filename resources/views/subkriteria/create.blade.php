...
@section('title', 'Tambah Subkriteria - ' . $kriteria->nama_kriteria)
    ...
    <div class="space-y-6">
        ...
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="mt-1 text-gray-600">Tambah data subkriteria baru untuk kriteria {{ $kriteria->nama_kriteria }}</p>
            </div>
        </div>

        <!-- Form -->
        <div class="glass-card rounded-2xl p-6 shadow-xl">
            <form action="{{ route('kriteria.subkriteria.store', $kriteria->id) }}" method="POST" class="space-y-6">
                @csrf
                    ...
                    <div class="form-group">
                        ...
                        <div class="relative">
                            ...
                            <input type="number" step="0.01" min="0" name="nilai" id="nilai" required
                                class="pl-10 py-3 text-base block w-full rounded-lg border-gray-300 shadow-sm focus:border-[var(--color-primary-500)] focus:ring focus:ring-[var(--color-primary-200)] focus:ring-opacity-50 transition duration-200"
                                placeholder="Contoh: 1, 2, 3, 4, 5" style="height: 46px;" value="{{ old('nilai') }}">
                        </div>
                    ...
                    <div class="form-group md:col-span-2">
                        ...
                        <div class="relative">
                            ...
                            <textarea id="keterangan" name="keterangan" rows="3"
                                ...
                                style="min-height: 100px;">{{ old('keterangan') }}</textarea>
                        </div>
                        @error('keterangan')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                ...
                <div class="pt-4 border-t border-gray-100">
                    <div class="flex justify-between items-center">
                        ...
                        <button type="submit"
                            ...
                            <i class="fas fa-save mr-2"></i> Simpan Subkriteria
                        </button>
                    </div>
                </div>
            </form>
