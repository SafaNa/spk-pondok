...
@section('content')
    <!-- Page Heading -->
    <div class="mb-2">
        <h1 class="text-3xl font-extrabold tracking-tight text-[#0d141b] dark:text-white sm:text-4xl mb-2">Sensitivity
            Analysis</h1>
        <p class="text-lg text-[#4c739a]">Evaluate how changes in criteria weights impact santri ranking recommendations for
            homecoming.</p>
    </div>
        ...
        <div class="overflow-x-auto">
            <table class="w-full text-sm text-left border-collapse">
                <thead
                    ...
                    <tr>
                        <th class="px-6 py-4 font-semibold" scope="col">Rank</th>
                        <th class="px-6 py-4 font-semibold" scope="col">Nama Santri</th>
                        <th class="px-6 py-4 font-semibold text-center" scope="col">Nilai Akhir</th>
                        <th class="px-6 py-4 font-semibold text-center" scope="col">Status</th>
                    </tr>
                </thead>
