...
@section('content')
    <div class="p-6">
        ...
        <div class="mb-8">
            ...
            <h1 class="font-outfit text-2xl font-bold text-gray-800 dark:text-white">Buat Event Liburan Baru</h1>
            <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Tambahkan event liburan untuk memproses kepulangan
                massal</p>
        </div>

        <div class="rounded-2xl bg-white p-8 shadow-sm ring-1 ring-gray-200 dark:bg-slate-800 dark:ring-slate-700">
            <form action="{{ route('licensing-events.store') }}" method="POST">
                @csrf
                ...
                <div class="grid gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="name" id="name" value="{{ old('name') }}" required
                            placeholder="Contoh: Libur Maulid 2026"
                    ...
                    <div class="rounded-xl bg-blue-50 p-5 ring-1 ring-blue-200 dark:bg-blue-900/10 dark:ring-blue-800">
                        <label class="flex cursor-pointer items-center gap-3">
                            ...
                            <div class="flex-1">
                                <div class="font-semibold text-blue-800 dark:text-blue-300">Aktifkan Segera</div>
                                <div class="text-sm text-blue-700 dark:text-blue-400">Event akan langsung aktif dan dapat
                                    divalidasi</div>
                            </div>
                        </label>
                    </div>
