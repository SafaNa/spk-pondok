...
@section('content')
                        ...
                        <div class="rounded-xl border border-red-100 bg-red-50/50 p-4 dark:border-red-900/30 dark:bg-red-900/10 transition-colors hover:bg-red-50 dark:hover:bg-red-900/20">
                            <label class="flex cursor-pointer items-start gap-3">
                                <div class="flex h-6 items-center">
                                    <input type="checkbox" name="is_emergency" value="1" id="is_emergency" {{ old('is_emergency', $license->is_emergency) ? 'checked' : '' }}
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            // Restore old() state or existing license state
