...
@section('title', 'Edit Izin Individu')
@section('breadcrumb', 'Edit Izin')
...
@section('content')
    <div class="flex flex-col gap-6 w-full mx-auto pb-10">
        ...
        <div class="bg-white dark:bg-slate-900 rounded-3xl shadow-xl overflow-hidden border border-slate-100 dark:border-slate-800">
                ...
                <div class="flex flex-col sm:flex-row items-center sm:items-start gap-6 text-center sm:text-left">
                    ...
                    <div>
                        <div class="flex items-center gap-3 mb-2">
                            <h1 class="text-2xl font-bold text-slate-900 dark:text-white tracking-tight">Edit Izin Individu</h1>
                        </div>
            ...
            {{-- Form --}}
            <form action="{{ route('admin.licenses.update', $license->id) }}" method="POST" class="p-4 sm:p-8">
                @csrf
                @method('PUT')
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div class="space-y-2">
                                ...
                                <div class="relative group">
                                    ...
                                    <input type="date" name="start_date" id="start_date" value="{{ old('start_date', $license->start_date->format('Y-m-d')) }}" required onchange="calculateDuration()"
                            ...
                            <div class="space-y-2">
                                ...
                                <div class="relative group">
                                    ...
                                    <input type="date" name="end_date" id="end_date" value="{{ old('end_date', $license->end_date->format('Y-m-d')) }}" required onchange="calculateDuration()"
                                        class="w-full pl-12 pr-4 py-3.5 rounded-xl border border-slate-200 dark:border-slate-600 bg-white dark:bg-slate-800 text-slate-700 dark:text-slate-200 font-normal focus:outline-none focus:border-primary/60 focus:ring-2 focus:ring-primary/20 transition-all duration-200">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="space-y-2">
                            ...
                            <div class="relative group">
                                ...
                                <textarea name="description" rows="3" required
                                    ...
                                    placeholder="Contoh: Sakit demam tinggi, Pulang karena ada acara nikahan kakak">{{ old('description', $license->description) }}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="rounded-xl border border-emerald-100 bg-emerald-50/50 p-4 dark:border-emerald-900/30 dark:bg-emerald-900/10 transition-colors hover:bg-emerald-50 dark:hover:bg-emerald-900/20">
                            <label class="flex cursor-pointer items-start gap-3">
                                <div class="flex h-6 items-center">
                                    <input type="checkbox" name="memorization_check" value="1" id="memorization_check" {{ old('memorization_check', $license->memorization_check) ? 'checked' : '' }}
