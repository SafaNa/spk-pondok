...
@section('content')
    <div class="rounded-2xl p-4 sm:p-6 border border-blue-100 mb-6"
        ...
        <div class="flex flex-col gap-1">
            <h1 class="text-[#0d141b] dark:text-white text-2xl font-black tracking-tight">Laporan Perizinan</h1>
            <p class="text-[#4c739a] text-sm font-normal">Ringkasan dan rekap data perizinan santri.</p>
        </div>
    </div>
    ...
    <div class="bg-white dark:bg-slate-900 rounded-xl shadow-sm border border-[#e7edf3] dark:border-slate-800 p-12 flex flex-col items-center justify-center text-center">
        <span class="material-symbols-outlined text-5xl text-slate-300 dark:text-slate-600 mb-4">summarize</span>
        <h3 class="text-base font-semibold text-slate-500 dark:text-slate-400">Fitur Laporan</h3>
