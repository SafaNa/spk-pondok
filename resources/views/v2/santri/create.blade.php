...
@section('breadcrumb', 'Santri / Tambah')
        ...
        <div
            ...
            <div
                ...
                <div class="flex flex-col sm:flex-row items-center sm:items-start gap-6 text-center sm:text-left">
                    ...
                    <div>
                        <h1 class="text-2xl font-bold mb-2 text-slate-900 dark:text-white tracking-tight">Tambah Santri Baru
                        </h1>
                        <p class="text-slate-500 dark:text-slate-400 text-base max-w-xl">Lengkapi biodata santri di bawah
                            ini untuk mendaftarkan santri baru ke dalam sistem.</p>
                    </div>
                </div>
            </div>

            {{-- Form --}}
            <form action="{{ route('santri.store') }}" method="POST" class="p-6 sm:p-10">
                @csrf
                            ...
                            <div class="space-y-2">
                                ...
                                <div class="relative group">
                                    ...
                                    <select name="status" required
                                        ...
                                        <option value="drop-out" {{ old('status') == 'drop-out' ? 'selected' : '' }}>Drop
                                            Out</option>
                                    </select>
                                    <div
