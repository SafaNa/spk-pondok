...
@section('title', 'Add Subkriteria - ' . $kriteria->nama_kriteria)
@section('mobile_title', 'Add Subkriteria')
@section('breadcrumb', 'Kriteria / Subkriteria / Add')
...
@section('content')
        ...
        <div class="flex flex-col md:flex-row md:items-start md:justify-between gap-4">
            <div>
                ...
                <p class="text-[#4c739a] mt-1">
                    Add a new sub-criteria value for <strong>{{ $kriteria->nama_kriteria }}</strong>.
                </p>
            </div>
        </div>
    </div>
    ...
    <div
        ...
        <form action="{{ route('kriteria.subkriteria.store', $kriteria->id) }}" method="POST" class="p-6 md:p-8 space-y-8">
            @csrf
            ...
            <div class="space-y-2">
                ...
                <input name="nama_subkriteria" value="{{ old('nama_subkriteria') }}" required
            ...
            <div class="space-y-2">
                ...
                <div class="relative max-w-xs">
                    <input name="nilai" value="{{ old('nilai') }}" required
            ...
            <div class="space-y-2">
                ...
                <textarea name="keterangan" rows="2"
                    ...
                    placeholder="Additional description...">{{ old('keterangan') }}</textarea>
            </div>
