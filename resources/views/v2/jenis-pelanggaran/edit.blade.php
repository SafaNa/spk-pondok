...
@section('breadcrumb', 'Jenis Pelanggaran / Edit')
@section('mobile_title', 'Edit Jenis Pelanggaran')
        ...
        <div
            ...
            <div
                ...
                <div class="flex flex-col sm:flex-row items-center sm:items-start gap-6 text-center sm:text-left">
                    ...
                    <div>
                        <h1 class="text-2xl font-bold mb-2 text-slate-900 dark:text-white tracking-tight">Edit Jenis
                            Pelanggaran</h1>
                        <p class="text-slate-500 dark:text-slate-400 text-base max-w-xl">Perbarui informasi jenis pelanggaran, poin, dan sanksi defaultnya.</p>
                    </div>
                </div>
            </div>

            {{-- Form --}}
            <form action="{{ route('jenis-pelanggaran.update', $jenisPelanggaran->id) }}" method="POST" class="p-6 sm:p-10">
                @csrf
                @method('PUT')
                                        ...
                                        <select name="departemen_id" required
                                            ...
                                            @foreach ($departemen as $dept)
                                                <option value="{{ $dept->id }}"
                                                    {{ old('departemen_id', $jenisPelanggaran->departemen_id) == $dept->id ? 'selected' : '' }}>
                                ...
                                <div class="relative group">
                                    ...
                                    <select name="kategori_pelanggaran_id" required
                                        ...
                                        @foreach ($kategori as $kat)
                                            <option value="{{ $kat->id }}"
                                                {{ old('kategori_pelanggaran_id', $jenisPelanggaran->kategori_pelanggaran_id) == $kat->id ? 'selected' : '' }}>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div class="space-y-2">
                                ...
                                <div class="relative group">
                                    ...
                                    <input type="text" name="kode_pelanggaran" value="{{ old('kode_pelanggaran', $jenisPelanggaran->kode_pelanggaran) }}"
                            ...
                            <div class="space-y-2">
                                ...
                                <div class="relative group">
                                    ...
                                    <input type="text" name="nama_pelanggaran" value="{{ old('nama_pelanggaran', $jenisPelanggaran->nama_pelanggaran) }}"
                                        required
                                        class="w-full pl-12 pr-4 py-3.5 rounded-xl border-2 border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-800 text-slate-800 dark:text-white placeholder:text-slate-400 font-medium focus:outline-none focus:border-primary focus:bg-white dark:focus:bg-slate-900 focus:ring-4 focus:ring-primary/10 transition-all duration-200"
                            ...
                            <div class="space-y-2 md:col-span-2">
                                ...
                                <div class="relative group">
                                    <textarea name="sanksi_default" rows="3" required
                                        ...
                                        placeholder="Sanksi yang diberikan secara default...">{{ old('sanksi_default', $jenisPelanggaran->sanksi_default) }}</textarea>
                                </div>
                             ...
                             <div class="space-y-2 md:col-span-2">
                                ...
                                <div class="relative group">
                                    <textarea name="deskripsi" rows="3"
                                        class="w-full px-4 py-3.5 rounded-xl border-2 border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-800 text-slate-800 dark:text-white placeholder:text-slate-400 font-medium focus:outline-none focus:border-primary focus:bg-white dark:focus:bg-slate-900 focus:ring-4 focus:ring-primary/10 transition-all duration-200 resize-none"
                                        placeholder="Penjelasan lebih detail mengenai pelanggaran...">{{ old('deskripsi', $jenisPelanggaran->deskripsi) }}</textarea>
                                </div>
                            </div>
                        </div>
                    </div>
