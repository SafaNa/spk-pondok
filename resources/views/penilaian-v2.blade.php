...
@section('content')
    ...
    <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        ...
        <a href="{{ route('penilaian-form-v2') }}"
            ...
            <table class="w-full text-sm text-left text-[#4c739a]">
                <thead
                    ...
                    <tr>
                        ...
                        <th class="px-6 py-4 font-bold tracking-wider" scope="col">Subkriteria</th>
                        <th class="px-6 py-4 font-bold tracking-wider" scope="col">Nilai</th>
