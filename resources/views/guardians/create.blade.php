        ...
        <div class="bg-white dark:bg-slate-900 rounded-3xl shadow-xl overflow-hidden border border-slate-100 dark:border-slate-800">
            ...
            <div class="bg-gradient-to-br from-primary/10 via-purple-500/5 to-pink-500/5 px-6 py-6 sm:px-8 sm:py-8 border-b border-primary/10">
                <div class="flex flex-col sm:flex-row items-center sm:items-start gap-6 text-center sm:text-left">
                    ...
                    <div>
                        <h1 class="text-2xl font-bold mb-2 text-slate-900 dark:text-white tracking-tight">Tambah Wali Santri</h1>
                        <p class="text-slate-500 dark:text-slate-400 text-base max-w-xl">Isi data wali dan pilih santri yang menjadi anaknya.</p>
                    </div>
                </div>
            </div>

            {{-- Form --}}
            <form action="{{ route('admin.guardians.store') }}" method="POST" class="p-6 sm:p-10 flex flex-col gap-10">
                @csrf
                        ...
                        <div class="space-y-2">
                            ...
                            <div class="relative group">
                                ...
                                <select name="relationship" required style="background-image: none;"
                                    ...
                                    <option value="uncle"         {{ old('relationship') == 'uncle'         ? 'selected' : '' }}>Paman</option>
                                    <option value="aunt"          {{ old('relationship') == 'aunt'          ? 'selected' : '' }}>Bibi</option>
                                    <option value="nephew_niece"  {{ old('relationship') == 'nephew_niece'  ? 'selected' : '' }}>Keponakan</option>
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="relative group">
                            ...
                            <textarea name="address" rows="3"
                                class="w-full pl-12 pr-4 py-3.5 rounded-xl border-2 border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-800 text-slate-800 dark:text-white placeholder:text-slate-400 font-medium focus:outline-none focus:border-primary focus:bg-white dark:focus:bg-slate-900 focus:ring-4 focus:ring-primary/10 transition-all duration-200"
                                placeholder="Alamat lengkap wali">{{ old('address') }}</textarea>
                        </div>
                    </div>
                </div>
                ...
                <div class="space-y-6">
                    ...
                    <div class="space-y-2">
                        ...
                        <p class="text-sm text-slate-400 flex items-center gap-1">
                            ...
                            Kosongkan jika belum ingin menghubungkan santri sekarang.
                        </p>
...
<script>
    ...
    const _guardianInitSelected = @json(old('student_ids', []));
    const _guardianInitObjects  = @json([]); {{-- create: tidak ada santri awal --}}
